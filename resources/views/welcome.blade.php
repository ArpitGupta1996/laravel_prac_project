            ...
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        ...
                        <a href="" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Test </a>
                    @else
      ...
      <script type="text/javascript">
        $(document).ready(function(){
           $('#WAButton').floatingWhatsApp({
                phone: '+919529756684', //WhatsApp Business phone number International format-
